...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'sexe'             => 'Sexe',
        'pays_exercice'    => "Pays d'exercice",
        'age'              => 'Age',
        'mode_exercice'    => "Mode d'exercice",
        'distance_hopital' => "Distance de l'hôpital",

        'interet_echo'     => "Intérêt de l'échographie",
        'interet_echo_oui' => "Oui à intérêt de l'échographie",
        'interet_echo_non' => "Non à intérêt de l'échographie",

        'temps_formation' => 'Temps de formation',
