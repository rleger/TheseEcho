...
use These\dto\Exceptions\InvalidDTOException;
use These\dto\Exceptions\PropertyAlreadyAssignedException;
...
abstract class DTOConstructor implements DTOConstructorInterface
{
    ...
    public function __construct($vars = null, $recursive = false, $overwrite = true)
    {
        $this->make($vars, $recursive, $overwrite);
    }
